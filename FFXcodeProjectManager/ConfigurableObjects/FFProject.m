...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        self.mainGroup = [aDecoder decodeObjectOfClass:[FFGroup class] forKey:kMainGroupKey];
        self.projectRefGroup = [aDecoder decodeObjectOfClass:[FFGroup class] forKey:kProjectRefGroupKey];
