...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        self.productReference = [aDecoder decodeObjectOfClass:[FFXcodeObject class] forKey:kProductReferenceKey];
